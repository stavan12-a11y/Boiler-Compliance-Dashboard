      ...
      history: [
        {
          ...
          date: dateOnly(400),
          startedAt: iso(400, 9),
          completedAt: iso(399, 14),
          notes: "Last inspection over a year ago — now overdue.",
          result: "pass",
          steps: completedSteps(400),
          repairs: [],
          status: "completed",
        },
      ],
      ...
      history: [
        {
          ...
          date: dateOnly(340),
          startedAt: iso(340, 9),
          completedAt: iso(339, 13),
          notes: "Annual inspection — next due soon.",
          result: "pass",
          steps: completedSteps(340),
          repairs: [],
          status: "completed",
        },
      ],
