        ...
        <form onSubmit={submit} className="rounded-2xl bg-white p-6 shadow-xl">
          ...
          {USING_DEFAULT_CREDENTIALS && (
            <p className="mt-4 rounded-lg bg-amber-50 px-3 py-2 text-xs text-amber-700">
              Using default credentials (<strong>admin</strong> /{" "}
              <strong>boiler-2026</strong>). Set <code>VITE_APP_USERNAME</code>{" "}
              and <code>VITE_APP_PASSWORD</code> in your hosting provider to
              choose your own, or configure Supabase for a real login.
            </p>
          )}
        </form>
      </div>
